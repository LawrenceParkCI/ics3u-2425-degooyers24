...
/**
* Description: This is a program for commenting
* Date: Oct. 17, 2024
...
public class Commenting {
  ...
  public static void main(String[] args) {
    ...
    */
    ...
    int num1 = 20; //Num1 is equal to 20
    double num2 = 36.2; //Num2 is equal to 36.2
    String stringNum = ""; // stringNum is equal to ''
